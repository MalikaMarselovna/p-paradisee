...
function Footer() {
  const SocialStyle =
    "m-3 rounded-full cursor-pointer p-2 text-white bg-[#f92e9e]";
  return (
    <footer>
      <>
        <Newsletter />
        <div className="container">
          <div className="flex flex-wrap  items-start justify-around
            ...
            <div className="flex flex-wrap p-2 w-[35%] ft:w-[100%] items-start">
              {/* Store information */}
            ...
            <div className="flex flex-col p-2 items-start justify-center">
              <h4 className="flex justify-center items-start mb-5 text-[25px] text-[#f92e9e] ml-4">
                Contact us
              </h4>
            ...
            <div className="flex flex-col p-2 ">
              ...
              <iframe
                ...
                className="w-[400px] h-[300px]  border-[#f92e9e] rounded-[10px]"
              ></iframe>
            </div>
          </div>
        </div>
